 ...
 * @author User
 */
public class Hiperten extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hiperten.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
