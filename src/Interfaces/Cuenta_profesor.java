 ...
 * @author User
 */
public class Cuenta_profesor extends javax.swing.JFrame {

    /**
     * Creates new form Cuenta
     */
    Connection conex;
    public Cuenta_profesor() {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setBackground(new java.awt.Color(228, 234, 246));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Inicio_Sesion.png"))); // NOI18N
    ...
    private void IniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IniciarActionPerformed
        ...
        String SQL = "SELECT * FROM profesor WHERE Usuario ='"+user+"' and Contra = '"+contra+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuenta_profesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cuenta_profesor().setVisible(true);
            }
        });
    }
