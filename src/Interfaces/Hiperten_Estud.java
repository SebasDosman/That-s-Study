 ...
 * @author User
 */
public class Hiperten_Estud extends javax.swing.JFrame {

    /**
     * Creates new form Hiperten
     */
    public Hiperten_Estud() {
        initComponents();
    ...
    private void SaludMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaludMouseClicked
       this.setVisible(false);
      Hiperten_Estud v = new Hiperten_Estud();
      v.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hiperten_Estud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Hiperten_Estud().setVisible(true);
            }
        });
    }
