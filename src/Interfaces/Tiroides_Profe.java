 ...
 * @author User
 */
public class Tiroides_Profe extends javax.swing.JFrame {

    /**
     * Creates new form Tiroides
     */
    public Tiroides_Profe() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Porqué tu doctor no supo diagnos.jpg"))); // NOI18N
        jPanel2.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 220, 190));
        ...
        jPanel2.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 300, 350, 40));

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel30.setText("<html>Primero, hay que aclarar que las personas con tiroides, nódulo tiroideo, hipotiroidismo o hipertiroidismo que están bien controlados no tienen un riesgo mayor de contagio por covid-19 ni de presentar una enfermedad grave por coronavirus, pero sí es importante que mantengan su medicación y tengan su control según lo indicado por su médico tratante, de tal forma de que estén con un tratamiento adecuado.<html>");
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 480, -1, -1));
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 360, -1, -1));
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 440, -1, -1));

        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel31.setText("<html>Los problemas de dicha enfermedad son mas comunes de lo que se creen porque el mal funcionamiento de esta glándula afecta a más de 300 millones de personas en el mundo y en el territorio nacional colombiano afecta al 4% de todos los colombianos, a causa de síntomas como el estrés, envejecimiento, los cambios de estilo de vida o la menopausia.<html>");
        jPanel2.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 510, 160));

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel32.setText("Tiroides");
        jPanel2.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 100, 40));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        if (java.awt.Desktop.isDesktopSupported()){
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)){
                try{
                    java.net.URI uri = new java.net.URI("http://tuendocrinologo.com/site/endocrinologia/tiroides/problemas-en-la-gandula-tiroides.html");
                    desktop.browse(uri);
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        if (java.awt.Desktop.isDesktopSupported()){
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)){
                try{
                    java.net.URI uri = new java.net.URI("https://www.clarin.com/entremujeres/bienestar/datos-clave-tiroides-dia-mundial-tiroides_0_HkYX-KFPQg.html");
                    desktop.browse(uri);
                }catch (URISyntaxException | IOException ex){}
            }
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        if (java.awt.Desktop.isDesktopSupported()){
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)){
                try{
                    java.net.URI uri = new java.net.URI("https://www.cancer.org/es/cancer/cancer-de-tiroides/tratamiento.html");
                    desktop.browse(uri);
                }catch (URISyntaxException | IOException ex){}
            }
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        if (java.awt.Desktop.isDesktopSupported()){
            ...
            if (desktop.isSupported(java.awt.Desktop.Action.BROWSE)){
                try{
                    java.net.URI uri = new java.net.URI("https://www.cun.es/enfermedades-tratamientos/enfermedades/hipertiroidismo");
                    desktop.browse(uri);
                }catch (URISyntaxException | IOException ex){}
            }
    ...
    private void SaludMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaludMouseClicked
      ...
      Tiroides_Profe v = new Tiroides_Profe();
      v.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tiroides_Profe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tiroides_Profe().setVisible(true);
            }
        });
    }
