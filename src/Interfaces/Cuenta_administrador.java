 ...
 * @author User
 */
public class Cuenta_administrador extends javax.swing.JFrame {
    ...
    public Cuenta_administrador() {
        try {
            ...
            this.setTitle("Iniciar sesión como administrador");
            transparente();
            textos();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 280, 200, 40));

        jSeparator1.setBackground(new java.awt.Color(0, 0, 0));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 430, 250, 10));

        jSeparator2.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator2.setAlignmentY(0.1F);
        jSeparator2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 320, 250, 10));
        ...
        getContentPane().add(Contra, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 390, 200, 40));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setText("Contraseña:");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 360, -1, -1));
        ...
        getContentPane().add(Iniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 470, -1, -1));
    ...
    private void IniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IniciarActionPerformed
        ...
        String SQL = "SELECT * FROM administrador WHERE Usuario ='"+user+"' and Contra = '"+contra+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuenta_administrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cuenta_administrador().setVisible(true);
            }
        });
    }
