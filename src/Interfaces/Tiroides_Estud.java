 ...
 * @author User
 */
public class Tiroides_Estud extends javax.swing.JFrame {

    /**
     * Creates new form Tiroides
     */
    public Tiroides_Estud() {
        initComponents();
    ...
    private void SaludMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaludMouseClicked
      this.setVisible(false);
      Tiroides_Estud v = new Tiroides_Estud();
      v.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tiroides_Estud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tiroides_Estud().setVisible(true);
            }
        });
    }
